...
public class FileSelectionActivity extends Activity {
    ...
    private static final String FILES_TO_UPLOAD = "up";
	...
	public void ok(){
	   ...
	   /* adapter = new FileArrayAdapter(FileSelectionActivity.this,R.layout.activity_file_chooser, resultFileList);
	    ListView lv = (ListView)findViewById(R.id.directorySelectionList);
